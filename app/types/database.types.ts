	...
	public: {
		Tables: {
			house_items: {
				...
				Relationships: [
					{
						foreignKeyName: 'house_items_house_id_fkey';
						columns: ['house_id'];
						isOneToOne: false;
					...
					{
						foreignKeyName: 'house_items_item_id_fkey';
						columns: ['item_id'];
						isOneToOne: false;
			...
			house_requests: {
				...
				Relationships: [
					{
						foreignKeyName: 'house_requests_house_id_fkey';
						columns: ['house_id'];
						isOneToOne: false;
						referencedRelation: 'houses';
						referencedColumns: ['id'];
		...
		Functions: {
			...
			create_request: {
				Args: { p_display_name: string; p_house_id: string };
				Returns: undefined;
			};
